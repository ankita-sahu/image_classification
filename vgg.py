...
if model_name == "VGG16":
        ...
        model_ft = models.squeezenet(pretrained=1)
...
torch.save(model_ft.state_dict(),'/home/kiit/Ankita/models/trained.model_vgg')

#Run this if you want to load the model
model_ft.load_state_dict(torch.load('/home/kiit/Ankita/models/trained.model_vgg'))
