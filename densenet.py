...
if model_name == "Densenet121":
        ...
        model_ft = models.densenet121(pretrained=1)
...
torch.save(model_ft.state_dict(),'/home/kiit/Ankita/models/trained.model_densenet')

#Run this if you want to load the model
model_ft.load_state_dict(torch.load('/home/kiit/Ankita/models/trained.model_densenet'))
