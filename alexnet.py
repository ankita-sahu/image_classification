...
if model_name == "alexnet":
        """ Alexnet
        """
        model_ft = models.alexnet(pretrained=1)
...
torch.save(model_ft.state_dict(),'/home/kiit/Ankita/models/trained.model_alexnet')

#Run this if you want to load the model
model_ft.load_state_dict(torch.load('/home/kiit/Ankita/models/trained.model_alexnet'))
